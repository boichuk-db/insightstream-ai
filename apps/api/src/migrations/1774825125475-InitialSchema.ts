...
export class InitialSchema1774825125475 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX "IDX_ab9126a074980674ba95d4cd35" ON "users" ("stripeCustomerId") `);
    ...
    await queryRunner.query(`CREATE TABLE "audit_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "action" character varying NOT NULL, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1bb179d048bbc581caa3b013439" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE INDEX "IDX_cfa83f61e4d27a87fcae1e025a" ON "audit_logs" ("userId") `);
    await queryRunner.query(`CREATE TABLE "teams" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "ownerId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7e5523774a38b08a6236d322403" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "feedbackId" uuid NOT NULL, "userId" uuid NOT NULL, "content" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE INDEX "IDX_a50590123a861952073d89e0a3" ON "comments" ("feedbackId") `);
    await queryRunner.query(`CREATE TABLE "activity_events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "teamId" uuid NOT NULL, "projectId" uuid, "actorId" uuid NOT NULL, "action" character varying NOT NULL, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f8e8d9dbf64f93f58ae52b4a9e4" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE INDEX "IDX_28e17b8294a6c88040765fce96" ON "activity_events" ("teamId") `);
    await queryRunner.query(`CREATE INDEX "IDX_f4b4c8e658af21a6199917e38c" ON "activity_events" ("projectId") `);
    await queryRunner.query(`ALTER TABLE "feedbacks" ADD CONSTRAINT "FK_3efdff2b6dc31de247fc611e9f6" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    await queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_a50590123a861952073d89e0a3f" FOREIGN KEY ("feedbackId") REFERENCES "feedbacks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_7e8d7c49f218ebb14314fdb3749" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "activity_events" ADD CONSTRAINT "FK_0a1d2a60fedb0f67305cbec4c24" FOREIGN KEY ("actorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "activity_events" DROP CONSTRAINT "FK_0a1d2a60fedb0f67305cbec4c24"`);
    ...
    await queryRunner.query(`ALTER TABLE "feedbacks" DROP CONSTRAINT "FK_3efdff2b6dc31de247fc611e9f6"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_f4b4c8e658af21a6199917e38c"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_28e17b8294a6c88040765fce96"`);
    await queryRunner.query(`DROP TABLE "activity_events"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_a50590123a861952073d89e0a3"`);
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_ab9126a074980674ba95d4cd35"`);

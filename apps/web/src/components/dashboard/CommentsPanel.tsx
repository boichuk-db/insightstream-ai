      ...
      {feedbackId && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-full max-w-md bg-neutral-900 border-l border-neutral-800 z-50 flex flex-col"
          >
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {isLoading ? (
                ...
                comments?.map((comment: any) => (
                  <div key={comment.id} className="bg-neutral-950/50 border border-neutral-800/50 rounded-xl p-3 group">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <span className="text-sm font-medium text-neutral-200">{comment.userEmail}</span>
            ...
            >
              <input
                ...
                className="flex-1 bg-neutral-950 border border-neutral-800 rounded-lg px-3 py-2 text-sm text-neutral-200 placeholder-neutral-600 focus:border-indigo-500 outline-none"
              />
              <button
                type="submit"

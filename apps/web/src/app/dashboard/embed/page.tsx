                  ...
                  <div className="mt-4 flex items-start gap-3 p-4 bg-brand-bg/50 rounded-xl border border-brand-border/50">
                    ...
                    <p className="text-xs text-brand-muted leading-relaxed">
                      {selectedFramework === "html" && (
                        <>
                          Paste this script into the <code>&lt;body&gt;</code>{" "}
                          tag of your website. It handles loading and
                      ...
                      {selectedFramework === "react" && (
                        <>
                          ...
                          <code>App.tsx</code> or layout wrapper. Make sure to
                          install dependencies if needed.
                        </>
                      )}
                      {selectedFramework === "angular" && (
                        <>
                          Use this standalone component in your Angular
                          application at the root level for global feedback
                          collection.
                        </>
                      )}
                    </p>

          ...
          >
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-zinc-950/50 rounded-xl border border-zinc-800/50">
                <p className="text-[10px] uppercase tracking-wider text-brand-muted font-semibold mb-1">AI Analysis</p>
            ...
            {PLAN_ORDER.map((planType) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs text-brand-muted mb-3">{config.description}</p>

                  <div className="flex items-baseline gap-1 mb-4">
                    <span className="text-2xl font-extrabold">
                      {config.price === 0 ? 'Free' : `$${config.price}`}
                    </span>
                    {config.price > 0 && <span className="text-brand-muted text-xs">/mo</span>}
                  </div>
  ...
  return (
    <div className="p-4 bg-zinc-950/50 rounded-xl border border-zinc-800/50">
      ...
      <p className="text-lg font-bold text-white">
        {current} <span className="text-zinc-500 text-sm font-normal">/ {max ?? '\u221e'}</span>
      </p>
      {max && (

    ...
    <div className="w-full max-w-sm mx-auto relative z-10">
      ...
      <div className="space-y-3 mb-6">
        <a
          ...
          className="flex items-center justify-center gap-3 w-full px-4 py-2.5 rounded-lg border border-brand-border bg-brand-surface hover:bg-brand-surface-hover transition-colors text-sm font-medium text-brand-fg"
        >
...
export default function Home() {
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-between bg-brand-surface p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-brand-fg font-medium flex items-center gap-2 text-xl">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-24 xl:px-32 relative bg-brand-bg">

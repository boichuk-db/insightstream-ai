            ...
            <div className="p-6 pt-4 relative z-10">
              {status === 'success' ? (
                <div className="py-12 flex flex-col items-center justify-center text-center gap-5">
                  ...
                  <div>
                    <h4 className="font-bold text-white text-xl">Feedback Received!</h4>
                    <p className="text-sm text-neutral-400 mt-2 max-w-[220px] mx-auto leading-relaxed">Our AI is now analyzing your input to improve the platform.</p>
                  </div>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  <div className="relative group">
                    <textarea
                      ...
                      style={{ borderColor: status === 'error' ? '#ef4444' : undefined }}
                    />
                  ...
                  {status === 'error' && (
                    <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-[11px] text-red-400 text-center font-semibold bg-red-400/5 py-3 rounded-2xl border border-red-400/10">
